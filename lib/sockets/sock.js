...
Socket.prototype.connect = function(port, host, fn){
  ...
  this.socketConnect(sock, port, host);
  return this;
};

/**
 * Client socket factory method. 
 *
 * This method is meant to be used by plugins and subclasses 
 * that want to change the way sockets are created.
 *
 * @return {Socket}
 * @api public
 */

Socket.prototype.newClientSocket = function () {
 ...
 *
 * This method is meant to be used by plugins and subclasses 
 * that want to change the way sockets are connected
 *
 * @param {Socket} sock
 * @param {Number|String|Object} port - A port number, a unix socket path or an options object
 * @param {String|Function} host - A host string or a callback function
 * @param {Function} callback
 * @api public
 */

Socket.prototype.socketConnect = function (sock, port, host, callback) {
  return sock.connect(port, host, callback)
};
...
Socket.prototype.bind = function(port, host, fn){
  ...
  this.server = this.createServer(this.onconnect.bind(this));
  ...
  if (unixSocket) {
    ...
    this.server.on('error', function(e) {
      if (e.code == 'EADDRINUSE') {
        ...
        var clientSocket = self.newClientSocket();
        ...
        self.socketConnect(clientSocket, {path: port}, function() {
...
Socket.prototype.createServer = function (connectionListener) {
